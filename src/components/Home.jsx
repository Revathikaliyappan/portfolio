...
function Home() {
  return (
    ...
    >
      {/* Background Glows */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-accent-primary/20 rounded-full blur-[128px] -z-10 animate-float"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent-secondary/20 rounded-full blur-[128px] -z-10 animate-float-reverse"></div>

      <div className="text-center max-w-4xl mx-auto z-10">
        <div className="flex flex-col items-center">
          <span className="opacity-0 animate-reveal inline-block px-4 py-1.5 mb-6 text-xs font-semibold tracking-widest text-accent-primary uppercase glass rounded-full">
            Available for freelance
          </span>

          <h1 className="opacity-0 animate-reveal [animation-delay:200ms] text-5xl md:text-8xl font-bold tracking-tight mb-4">
            Creative <span className="text-gradient">Designer</span>
          </h1>

          <p className="opacity-0 animate-reveal [animation-delay:400ms] text-lg md:text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="opacity-0 animate-reveal [animation-delay:600ms] flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <a
